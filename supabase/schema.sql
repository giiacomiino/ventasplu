...
-- Compara del día 1 al último día con datos del mes actual
-- contra los mismos días del mes anterior.
-- =============================================
...
BEGIN
  -- Último día con datos en el mes actual para esta categoría
  ...
  -- Cap al último día del mes anterior (ej: si v_ultimo_dia=31 y el mes ant tiene 30 días)
