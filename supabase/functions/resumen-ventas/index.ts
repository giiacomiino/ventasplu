import { corsHeaders, json, bubbleEnv, bubbleGet, conOrg, isoWeekday, requirePermiso } from '../_shared/bubble.ts'
...
Deno.serve(async (req) => {
  ...
  const user = await requirePermiso(req, ['rh', 'pnl', 'ventas', 'dashboard'])
